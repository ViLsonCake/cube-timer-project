...
public class ValidationConst {
    ...
    public static final String EMAIL_EMPTY_MESSAGE = "Email can't be empty"; public static final String PASSWORD_EMPTY_MESSAGE = "Password can't be empty";
    ...
    public static final String PENALTY_DEFAULT_VALUE = "None";
}
